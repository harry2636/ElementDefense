...
if (keyboard_check_pressed(ord("1"))){
  ...
  if(obj_build_area.on_enemy == 0 && global.tower_fire > 0){
    if(obj_build_area.on_tower == 1){
      if(obj_build_area.upgradeable == 1){
        tower = instance_place(tower_x, tower_y, obj_tower_parent);
        with(tower){
          lvl += 1;
          event_user(0);
        }
...
if (keyboard_check_pressed(ord("2"))){
  tower_x = obj_build_area.x;
  tower_y = obj_build_area.y;
  if(obj_build_area.on_enemy == 0 && global.tower_wind > 0){
    if(obj_build_area.on_tower == 1){
...
if (keyboard_check_pressed(ord("3"))){
  tower_x = obj_build_area.x;
  tower_y = obj_build_area.y;
  if(obj_build_area.on_enemy == 0 && global.tower_thunder > 0){
    if(obj_build_area.on_tower == 1){
...
if (keyboard_check_pressed(ord("4"))){
  tower_x = obj_build_area.x;
  tower_y = obj_build_area.y;
  if(obj_build_area.on_enemy == 0 && global.tower_ice > 0){
    if(obj_build_area.on_tower == 1){
